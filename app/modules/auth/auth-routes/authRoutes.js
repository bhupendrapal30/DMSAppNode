...
router.post('/addincidentdetails',authMiddleware.checkToken,userController.addincidentdetails);
router.get('/incidentdetailslist',authMiddleware.checkToken,userController.incidentdetailslist);
router.post('/incidentdetails',authMiddleware.checkToken,userController.incidentdetails);
router.post('/incidentdetailsnupdate',authMiddleware.checkToken,userController.incidentdetailsnupdate);
router.post('/addrootcauseanalysisdetails',authMiddleware.checkToken,userController.addrootcauseanalysisdetails);
router.get('/rootcauseanalysisdetailslist',authMiddleware.checkToken,userController.rootcauseanalysisdetailslist);
router.post('/rootcauseanalysisdetails',authMiddleware.checkToken,userController.rootcauseanalysisdetails);
router.post('/rootcauseanalysisdetailsupdate',authMiddleware.checkToken,userController.rootcauseanalysisdetailsupdate);
router.post('/addcorrectiveactiondetails',authMiddleware.checkToken,userController.addcorrectiveactiondetails);
router.get('/correctiveactiondetailslist',authMiddleware.checkToken,userController.correctiveactiondetailslist);
router.post('/correctiveactiondetails',authMiddleware.checkToken,userController.correctiveactiondetails);
router.post('/correctiveactiondetailsupdate',authMiddleware.checkToken,userController.correctiveactiondetailsupdate);
router.post('/addcorrectionActiondetails',authMiddleware.checkToken,userController.addcorrectionActiondetails);
...
router.post('/addvendordetails',authMiddleware.checkToken,userController.addvendordetails);
router.get('/vendordetailslist',authMiddleware.checkToken,userController.vendordetailslist);
router.post('/vendordetails',authMiddleware.checkToken,userController.vendordetails);
router.post('/vendordetailsupdate',authMiddleware.checkToken,userController.vendordetailsupdate);
router.post('/addvendorperformancerating',authMiddleware.checkToken,userController.addvendorperformancerating);
