...
router.get('/defaultfilelist',authMiddleware.checkToken,userController.defaultfilelist); 
...
router.get('/permissionlist',authMiddleware.checkToken,userController.permissionlist);
